...
class passive_model_params(sa.shared_assumptions):
    def __init__(self,which_GHG):
        ...
        self.painting_capex_per_m2 = 15.0 #$/m2
        self.opex_per_m2 = 1.8 #$/m2-y
        self.catalyst_capex_per_m2 = 1.07 #$/m2
...
def calculate_cost_per_m2_year(params,outputs): # Returns the annualized cost per m2 of mounted active phase
    ...
    # Print-tests to clarify the cost breakdown between painting, catalyst, and maintenance
    #print('Paint: '+str(params.CRF*params.painting_capex_per_m2/annual_cost))
    #print('Catalyst: '+str(params.CRF*params.catalyst_capex_per_m2/annual_cost))
    #print('Opex: '+str(annual_opex/annual_cost))
